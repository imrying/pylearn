...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('test_case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.testcase')),
            ],
        ),
        migrations.CreateModel(
            name='SchoolClass',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ouput_description', models.CharField(max_length=200)),
                ('limit_description', models.CharField(max_length=200)),
                ('due_date', models.DateField()),
                ('assignment_answers', models.ManyToManyField(blank=True, to='app.Answer')),
                ('school_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.schoolclass')),
